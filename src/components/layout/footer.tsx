    ...
    <footer className="border-t bg-muted/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-3 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 col-span-3 md:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">ShopNex</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Modern e-commerce storefront built for the future of online shopping.
            </p>
          </div>
        ...
        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2024 ShopNex. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
