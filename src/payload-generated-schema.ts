...
export const products_product_attributes = pgTable(
  ...
  (columns) => [
    index('products_product_attributes_order_idx').on(columns._order),
    index('products_product_attributes_parent_id_idx').on(columns._parentID),
    index('products_product_attributes_attribute_idx').on(columns.attribute),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [products.id],
      name: 'products_product_attributes_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const relations_products_product_attributes = relations(
  products_product_attributes,
  ({ one }) => ({
    _parentID: one(products, {
      fields: [products_product_attributes._parentID],
      references: [products.id],
      relationName: 'productAttributes',
    }),
    attribute: one(attributes, {
      fields: [products_product_attributes.attribute],
      references: [attributes.id],
      relationName: 'attribute',
    }),
  }),
...
export const relations_products = relations(products, ({ many }) => ({
  ...
  productAttributes: many(products_product_attributes, {
    relationName: 'productAttributes',
  }),
...
type DatabaseSchema = {
  ...
  products_product_attributes: typeof products_product_attributes
  ...
  relations_products_product_attributes: typeof relations_products_product_attributes
